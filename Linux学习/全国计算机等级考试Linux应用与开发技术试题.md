...
45. ==某==文件的权限为：`drw-r--r--`，用数值形式表示该权限，则该八进制数为\_\_\_\_\_\_\_\_\_\_。
46. `mv` 命令用来将文件从一个目录移到另一个目录中，还可以对文件\_\_重命名_\_\_\_\_\_\_\_。
47. 在linux系统中，所有的变量都默认是字符串，如果进行算术运算，将变量a和b的值相加，赋给变量c，其语法格式为\_\_\_\_c=$\[ a + b ]\_\_\_\_\_\_。
48. ==给==出一分命令统计当前工作目录下所有以**m开头的C语言源文件**的数量\_find . -name "" | wc -l\_\_\_\_\_\_\_\_\_。
49. 在linux系统中，用gcc编译c语言的源文件 `f1.c`，生成可执行文件 `f1` 的命令是\_\_\_\_gcc f1.c -o f1\_\_\_\_\_\_。
50. ==Lin==ux系统的守护进程及多数日志文件是由\_\_\_\_\_\_\_\_\_\_服务来统一管理的，只要各个进程将信息给予这个服务，它就会自动地把日志按特定的格式记录到不同的日志文件中。
...
则运行该脚本，应执行以下命令：
【59】\_\_\_\_\_\_\_\_\_\_chmod a+x sh01
