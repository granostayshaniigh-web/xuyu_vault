...
45. ==命==令\_\_\_\_\_\_\_\_\_\_显示文件系统空间使用情况，命令\_\_\_\_\_df\_\_\_\_\_显示目录或文件占用磁盘空间量。
...
48. 想知道当前目录的绝对路径，可以在字符界面下输入\_\_\_\_\_\pwd_\_\_\_\_命令。
...
```
==(8) 由==于 `test` 程序执行时间过长，用户输入以下命令强制结束该进程：
...
#通过num和game确定计算机的出拳
computer=【63】_game[num]_________
echo "请根据下列提示选择您的出拳手势"
echo "1.石头"
echo "2.剪刀"
echo "3.布"
【64】____read__ "请选择1-3:" person
